...
import { Mail, User, Phone, ShieldCheck, Ticket, ArrowLeft } from 'lucide-react';
...
const Checkout: React.FC = () => {
    ...
    try {
      ...
      if (window.snap) {
        window.snap.pay(snapToken, {
          onSuccess: () => {
            alert("Pembayaran Berhasil! E-Ticket akan dikirim ke email kamu.");
            navigate('/');
          },
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col md:flex-row font-sans text-gray-900 pt-[80px] md:pt-0">
